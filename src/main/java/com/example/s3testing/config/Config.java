package com.example.s3testing.config;
...
@Configuration
// mapping 이 될 객체가 위치한 곳에 value를 걸어줘야함.
@MapperScan(value = "com.example.s3testing.repository.dao", sqlSessionFactoryRef = "SqlSessionFactory")
public class Config {
